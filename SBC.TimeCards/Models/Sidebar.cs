...
namespace SBC.TimeCards.Models
{
    ...
    public static class Sidebar
    {
        public static List<SidebarItem> AdminItems = new List<SidebarItem>  {
            // Dashboard
            new SidebarItem() { Id = 1, Name = "Dashboard", Controller = "Home", Action = "Index", IsParent=false, ParentId=0 , IconClass="fas fa-fw fa-tachometer-alt"},
            // Projects
            new SidebarItem() { Id = 2, Name = "Projects", Controller = "Projects", IsParent=true, ParentId=0, IconClass="fas fa-fw fa-cog" },
            ...
            // Users
            new SidebarItem() { Id = 5, Name = "Users", Controller = "Users", IsParent=true, ParentId=0 , IconClass="fas fa-fw fa-users"},
